...
| Field    | Value                                                                                                                                                                                                                                                                                                                       |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status   | Implemented 2026-07-13 (§7.1-7.6; §7.7 skipped, below threshold — see §10). `make precommit SKIP=1` measured 98.65s post-implementation vs the 337s baseline. §7.8 (micro) not done. §11.1 option (b) implemented 2026-07-20: R2 `collection/reviews.json.gz` partitioned by month as `collection/reviews/YYYY-MM.json.gz`. |
