...
r2_utils = SourceFileLoader("r2_utils", "/Users/lz/Library/Application Support/Anki2/addons21/data/anki/upload-to-r2").load_module()

BASE = Path('/Users/lz/Library/Application Support/Anki2/addons21')
PUBLIC_FILES = [
    'graph/graph_data_public.json',
    'graph/history_data_public.json'
]
...
def upload_public_data():
    ...
    print(f"🌐 Data is now available at your R2 public endpoint under /graph/...")
