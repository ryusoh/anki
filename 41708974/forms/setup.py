...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.statusMsg = QtWidgets.QLineEdit(self.tabAccount)
        self.statusMsg.setMaxLength(280)
        ...
        self.gl2 = QtWidgets.QGridLayout()
        self.gl2.setObjectName("gl2")
        self.gl3 = QtWidgets.QGridLayout()
        self.gl3.setObjectName("gl3")
        self.next_day_info1 = QtWidgets.QLabel(self.tabSettings)
        ...
        self.next_day_info2 = QtWidgets.QLabel(self.tabSettings)
        self.next_day_info2.setObjectName("next_day_info2")
        self.gl3.addWidget(self.next_day_info2, 0, 2, 1, 1)
        self.newday = QtWidgets.QSpinBox(self.tabSettings)
        ...
        self.Default_Tab = QtWidgets.QComboBox(self.tabSettings)
        ...
        self.gl2.addLayout(self.gl3, 1, 0, 1, 2)
        self.country = QtWidgets.QComboBox(self.tabSettings)
        self.country.setObjectName("country")
        self.country.addItem("")
        self.gl2.addWidget(self.country, 0, 0, 1, 2)
        self.verticalLayout_3.addLayout(self.gl2)
        self.scroll = QtWidgets.QCheckBox(self.tabSettings)
        self.scroll.setObjectName("scroll")
        self.verticalLayout_3.addWidget(self.scroll)
        self.refresh = QtWidgets.QCheckBox(self.tabSettings)
        self.refresh.setEnabled(True)
        self.refresh.setObjectName("refresh")
        self.verticalLayout_3.addWidget(self.refresh)
        self.autosync = QtWidgets.QCheckBox(self.tabSettings)
        self.autosync.setObjectName("autosync")
        self.verticalLayout_3.addWidget(self.autosync)
        self.medals = QtWidgets.QCheckBox(self.tabSettings)
        self.medals.setObjectName("medals")
        self.verticalLayout_3.addWidget(self.medals)
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.tabGroup)
        ...
        self.gridLayout.addWidget(self.new_repeat_pwd_label, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.newPwd, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.newRepeat, 5, 1, 1, 1)
        self.new_pwd_label = QtWidgets.QLabel(self.groupBox_3)
        self.new_pwd_label.setObjectName("new_pwd_label")
        self.gridLayout.addWidget(self.new_pwd_label, 4, 0, 1, 1)
        ...
        self.mailGroup = QtWidgets.QLineEdit(self.groupBox_3)
        self.mailGroup.setObjectName("mailGroup")
        self.gridLayout.addWidget(self.mailGroup, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.add_newGroup, 6, 0, 1, 2)
...
"}")
        ...
        Dialog.setTabOrder(self.autosync, self.LB_DeckBrowser)
        ...
        Dialog.setTabOrder(self.joinGroup, self.newGroup)
        Dialog.setTabOrder(self.newGroup, self.mailGroup)
        Dialog.setTabOrder(self.mailGroup, self.newPwd)
        ...
        Dialog.setTabOrder(self.unhideButton, self.tabWidget)
        Dialog.setTabOrder(self.tabWidget, self.about_text)
...
"Sorting will be disabled"))
        ...
        self.LB_DeckBrowser.setText(_translate("Dialog", "Show leaderboard on home screen (only works with Anki 2.1.20+)"))
        self.lb_focus.setText(_translate("Dialog", "Focus on user"))
        self.maxUsers_Label.setText(_translate("Dialog", "Maximum number of users on home screen leaderboard:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSettings), _translate("Dialog", "Settings"))
        self.groupBox_2.setTitle(_translate("Dialog", "Join"))
        ...
        self.groupBox_3.setTitle(_translate("Dialog", "New"))
        self.new_repeat_pwd_label.setText(_translate("Dialog", "Repeat password:"))
        self.label_2.setText(_translate("Dialog", "E-Mail address:"))
        ...
        self.mailGroup.setPlaceholderText(_translate("Dialog", "optional"))
        self.add_newGroup.setText(_translate("Dialog", "Request Group"))
        self.groupBox_4.setTitle(_translate("Dialog", "Manage"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGroup), _translate("Dialog", "Group"))
