...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        self.Global_Leaderboard.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Global_Leaderboard.setAlternatingRowColors(True)
        self.Global_Leaderboard.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.Global_Leaderboard.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.Global_Leaderboard.setShowGrid(True)
        self.Global_Leaderboard.setObjectName("Global_Leaderboard")
        self.Global_Leaderboard.setColumnCount(6)
        ...
        self.Friends_Leaderboard.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.Friends_Leaderboard.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Friends_Leaderboard.setAlternatingRowColors(True)
        self.Friends_Leaderboard.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.Friends_Leaderboard.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.Friends_Leaderboard.setShowGrid(True)
        self.Friends_Leaderboard.setObjectName("Friends_Leaderboard")
        self.Friends_Leaderboard.setColumnCount(6)
        ...
        self.Country_Leaderboard.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.Country_Leaderboard.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Country_Leaderboard.setAlternatingRowColors(True)
        self.Country_Leaderboard.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.Country_Leaderboard.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.Country_Leaderboard.setShowGrid(True)
        self.Country_Leaderboard.setObjectName("Country_Leaderboard")
        self.Country_Leaderboard.setColumnCount(6)
        ...
        self.Custom_Leaderboard.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.Custom_Leaderboard.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Custom_Leaderboard.setAlternatingRowColors(True)
        self.Custom_Leaderboard.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.Custom_Leaderboard.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.Custom_Leaderboard.setShowGrid(True)
        self.Custom_Leaderboard.setObjectName("Custom_Leaderboard")
        self.Custom_Leaderboard.setColumnCount(6)
        ...
        self.League.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.League.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.League.setAlternatingRowColors(True)
        self.League.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.League.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.League.setObjectName("League")
        self.League.setColumnCount(6)
    ...
    def retranslateUi(self, dialog):
        ...
        item.setText(_translate("dialog", "Retention %"))
        self.Parent.setTabText(self.Parent.indexOf(self.tab_4), _translate("dialog", "Custom"))
        ...
        item = self.League.horizontalHeaderItem(0)
        item.setText(_translate("dialog", "Username"))
