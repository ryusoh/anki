"""Proxy-fallback behaviour for auto_itaigi API calls: direct connection first,
...
from auto_itaigi import proxy_fallback
from auto_itaigi.proxy_fallback import urlopen_with_proxy_fallback
