...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("review_heatmap:icons/patreon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("review_heatmap:icons/heart.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
