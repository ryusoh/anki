...
<div class="heatmap">
    <div class="heatmap-controls">
        ...
        <div class="aligncenter">
            <div onclick="reviewHeatmap.onHmNavigate(event, this, 'prev');" ondblclick="reviewHeatmap.onHmNavigate(event, this, 'prev');" class="hm-btn">
                <img height="10px" src="{WEB_BASE}/assets/left.svg" />
            </div>
            <div onclick="reviewHeatmap.onHmHome(event, this);" class="hm-btn">
                <img height="10px" src="{WEB_BASE}/assets/circle.svg" />
            </div>
            <div onclick="reviewHeatmap.onHmNavigate(event, this, 'next');" ondblclick="reviewHeatmap.onHmNavigate(event, this, 'next');" class="hm-btn">
