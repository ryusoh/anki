...
def make_window_transparent(win_id):
    ...
    try:
        ...
        msgSend_ptr = ctypes.cast(
            objc_lib.objc_msgSend,
        ...
        sel_setTitlebarAppearsTransparent = objc_lib.sel_registerName(
            b"setTitlebarAppearsTransparent:"
        )
        msgSend_bool = ctypes.cast(
            objc_lib.objc_msgSend,
