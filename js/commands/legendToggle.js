...
/**
 * @typedef {Object} ChartDatasetMeta
 ...
 * @property {(index: number) => ChartDatasetMeta} getDatasetMeta
 * @property {(mode?: string) => void} update
 */
 ...
 *
 * @param {ChartInstance} chart - Chart.js instance
