...
export function createCommandTrie() {
    ...
    trie.insertAll([
        ...
        'clear', 'cls', 'c',   // clear
        'plot', 'p',           // plot umbrella
        'plot due', 'pd',      // plot due abbreviation
        'plot reviews', 'pr',  // plot reviews abbreviation
        'due', 'd',            // due shortcut
        'future', 'f',         // future shortcut
        'reviews', 'r',        // reviews shortcut
        'show', 's',           // show command
        'show due', 'sd',      // show due
        'show reviews', 'sr'   // show reviews
    ]);
