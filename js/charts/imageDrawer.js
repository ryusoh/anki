...
export function drawImage(ctx, arc, img, logoInfo) {
  ...
  const globalMode =
    LOGO_SIZE && (LOGO_SIZE.mode === "px" || LOGO_SIZE.mode === "ratio")
      ...
      : "ratio";
  const globalValue =
    LOGO_SIZE && typeof LOGO_SIZE.value === "number" ? LOGO_SIZE.value : 0.12;
  const globalMinPx =
    LOGO_SIZE && typeof LOGO_SIZE.minPx === "number" ? LOGO_SIZE.minPx : 14;
  ...
  if (
    ...
    typeof logoInfo.rotationOffsetDeg === "number"
  ) {
