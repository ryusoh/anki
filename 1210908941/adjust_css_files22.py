...
def adjust_toolbar_css22(filecontent):
    cont = add_bg_img(filecontent, imgname.replace("a.png", "b.png"), "top", False)
    return cont

def adjust_bottomtoolbar_css22(filecontent):
    cont = add_bg_img(filecontent, imgname.replace("a.png", "b.png"), "bottom", False, True)
    return cont
...
def adjust_reviewer_css22(filecontent):
    cont = add_bg_img(filecontent, imgname.replace("a.png", "b.png"), "body", True, False)
    return cont    

def adjust_reviewerbottom_css22(filecontent):
    cont = add_bg_img(filecontent, imgname.replace("a.png", "b.png"), "bottom", False, False)
    return cont       
