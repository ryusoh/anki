...
from awesome_tts.proxy_fallback import _detect_local_proxy, urlopen_with_proxy_fallback
...
def test_urlopen_with_proxy_fallback_httperror_proxy():
    req = urllib.request.Request('http://example.com')
    import awesome_tts.proxy_fallback as proxy_fallback
...
def test_urlopen_with_proxy_fallback_direct_opener_httperror():
    ...
    with patch('urllib.request.urlopen', side_effect=OSError):
        with patch('awesome_tts.proxy_fallback._build_direct_opener', return_value=mock_opener):
            try:
                urlopen_with_proxy_fallback(req)
            except HTTPError:
                pass
...
def test_build_direct_opener():
    from awesome_tts.proxy_fallback import _build_direct_opener
