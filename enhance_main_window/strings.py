...
defaultHeader = {
    **{
        ...
        "reviewed today/repeated today": _("reviewed")
        + "/"
        + "<br/>"
        + _("repeated")
        + "<br/>"
...
defaultOverlay = {
    **{
        "cards seen today": _("Cards seen today")
        + "<br/>"
        + _("""cards you'll see today which are not new"""),
        "learning card": _("Cards in learning")
        + "<br/>"
        + _("""(either new cards you see again,""")
        + "<br/>"
        + _("or cards which you have forgotten recently.")
        + "<br/>"
        + _("""Assuming those cards didn't graduated)"""),
        "learning later": _("Review which will happen later.")
        + "<br/>"
        + _("Either because a review happened recently,")
        + "<br/>"
        + _("or because the card have many review left."),
        "learning now": _("Cards in learning which are due now.")
        + "<br/>"
        + _("If there are no such cards,")
        + "<br/>"
        + _("the time in minutes")
        + "<br/>"
        + _("or seconds until another learning card is due"),
        "learning today": _("Cards in learning which are due now and then later."),
        "learning all": _("Cards in learning which are due now")
        + "<br/>"
        + _("(and in parenthesis, the number of reviews")
        + "<br/>"
        + _("which are due later)"),
        "review due": _("Review cards which are due today")
        + "<br/>"
        + _("(not counting the one in learning)"),
        "due tomorrow": _("Review cards which are due tomorrow")
        + "<br/>"
        + _("(note: new cards and lapsed card seen today may increase this number.)"),
        "review today": _("Review cards you will see today"),
        "review": _("Review cards cards you will see today")
        + "<br/>"
        + _("(and the ones you will not see today)"),
        ...
        "reviewed today/repeated today": _(
            "Number of cards and of review<br/>from this deck today."
        ),
        ...
        "new": _("Unseen")
        + _("cards")
        + _("you will see today")
        + "<br/>"
        + _("(what anki calls ")
        + _("new cards"),
        "unseen new": _("Unseen cards you will see today")
        + "<br/>"
        + _("(and those you will not see today)"),
        "buried": _("number of buried cards,")
        + "<br/>"
        + _("(cards you decided not to see today)"),
        "buried/suspended": _("number of buried cards,")
        + "<br/>"
        + _("(cards you decided not to see today)")
        + _("number of suspended cards,")
        + "<br/>"
        + _("(cards you will never see")
        + "<br/>"
        + _("unless you unsuspend them in the browser)"),
        "suspended": _("number of suspended cards,")
        + "<br/>"
        + _("(cards you will never see")
        + "<br/>"
        + _("unless you unsuspend them in the browser)"),
        ...
        "today": _("Number of review you will see today")
        + "<br/>"
        + _("(new, review and learning)"),
        "undue": _("Number of cards reviewed, not yet due"),
        "mature/young": _("Number of cards reviewed,")
        + "<br/>"
