...
A red gate (``make precommit SKIP=1``) over an untouched worktree cannot go
...
``HEAD``, and the contents of untracked files, so any edit — staged,
unstaged, or to a brand-new file — changes it.
"""
