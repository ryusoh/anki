...
(Clash/Shadowsocks/Astrill-style localhost listener), HTTP errors untouched."""
...
from auto_image import proxy_fallback, utils
from auto_image.proxy_fallback import urlopen_with_proxy_fallback
